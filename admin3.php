       ...
       <?php
        ...
        <tr id="property">
           <th scope="row"><?php echo $result['id_property']?></th>
             ...
             <td scope="row"><?php echo $result['alamat']?></td>
             <td scope="row"><?php echo $result['floor_area']?></td>
             ...
             <td scope="row">
             <a href="update.php?id_property=<?=$result['id_property']?>" class="btn btn-success" style="text-decoration:none;">Edit</a>
             <a href="hapusp.php?id_property=<?=$result['id_property']?>" class="btn btn-danger" style="text-decoration:none;">Hapus</a>
            </td>
            <?php } ?>
         </tr>
        </tbody>
       </table>
       <a href="create.php" class="btn btn-warning" style="text-decoration:none;">Add</a>
          </div>
           </ul>
     </section>
