...
<body>
  ...
  <section id="home" class="home-section">
    ...
    <div class="card">
       ...
       <?php
        include 'konek.php';
        $query = "SELECT * FROM lastverif";
        $data=mysqli_query($info, $query);
        while($result=mysqli_fetch_array($data)){?>
        <tr id="property">
           <th scope="row"><?php echo $result['id_last']?></th>
             <td scope="row"><?php echo $result['datebuy']?></td>
             <td scope="row"><?php echo $result['id_user']?></td>
             <td scope="row"><?php echo $result['nik']?></td>
             <td scope="row"><?php echo $result['id_property']?></td>
             <td scope="row"><?php echo $result['card_number']?></td>
             <td scope="row">
             <a href="hapusl.php?id_last=<?=$result['id_last']?>" class="btn btn-danger" style="text-decoration:none;">Hapus</a>
            </td>
            <?php } ?>
         </tr>
        </tbody>
