...
if(isset($_POST['tambah'])){
  ...
  $sql1 = "INSERT INTO property(alamat, price, room, floor_area, img1) values('$alamat', '$price', '$room', '$floor', '$img1')";
...
<div class=" mx-auto position-relative pt-5" >
    <div class="table translate-middle" >
        ...
        <div class="mb-3">
          ...
          <input type="submit" name="tambah" value="Done !" class="btn btn-warning">
          <br>
          </form>
    </div>
</div>
